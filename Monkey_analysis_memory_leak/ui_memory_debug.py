...
# Form implementation generated from reading ui file 'G:\monitor_log\venv\Scripts\UI_memory_debug.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_analysis.setGeometry(QtCore.QRect(20, 500, 111, 31))
        ...
        self.label_local_package.setGeometry(QtCore.QRect(390, 70, 54, 12))
        self.label_local_package.setObjectName("label_local_package")
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(140, 506, 118, 20))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(170, 250, 111, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.listWidget_all.isSortingEnabled()
        self.listWidget_all.setSortingEnabled(False)
        item = self.listWidget_all.item(0)
        item.setText(_translate("MainWindow", "test"))
        self.listWidget_all.setSortingEnabled(__sortingEnabled)
